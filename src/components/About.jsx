...
function About() {
  return (
    <div className="p-5 m-2 text-light text-center bg-dark" id="home">
      <h1>About</h1>
      <h2>Looking for USA or UK Remote Job</h2>
      <p>
        We have Team of Developers across the India. we and my team take
